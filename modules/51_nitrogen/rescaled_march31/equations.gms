...
q51_emissions_man_crop_detailed(i2,kli,n_pollutants_direct)..
                  v51_emissions_man_crop_detailed(i2,kli,n_pollutants_direct)
                  =e=
                  vm_manure_recycling_detailed(i2,kli,"nr")
                  / (1-s51_snupe_base) * (1-vm_nr_eff(i2))
                  * sum(ct, i51_ef_n_soil(ct,i2,n_pollutants_direct,"man_crop"));
...
*' crop residues decaying on fields:
 ...
 q51_emissions_resid_detailed(i2,kcr,n_pollutants_direct)..
                v51_emissions_resid_detailed(i2,kcr,n_pollutants_direct)
                =e=
                vm_res_recycling_detailed(i2,kcr) * sum(ct, i51_ef_n_soil(ct,i2,n_pollutants_direct,"resid"))
                / (1-s51_snupe_base) * (1-vm_nr_eff(i2));;
...
*' emissions from burning crop residues, N2O and NOx
 ...
 q51_emissions_resid_burn_detailed(i2,kcr,n_pollutants_direct)..
                  v51_emissions_resid_burn_detailed(i2,kcr,n_pollutants_direct)
                  =e=
                  vm_res_ag_burn(i2,kcr,"dm") * f51_ef_resid_burn(n_pollutants_direct);
...
*' specific to N2O and assumed to apply also to NH3 and other losses.
 q51_emissionbal_awms(i2,n_pollutants_direct) ..
  ...
  q51_emissionbal_awms_detailed(i2,kli,n_pollutants_direct) ..
                  v51_emissionbal_awms_detailed(i2,kli,n_pollutants_direct)
                  =e=
                  sum(awms_conf,
                      vm_manure_confinement(i2,kli,awms_conf,"nr")
                      * f51_ef3_confinement(i2,kli,awms_conf,n_pollutants_direct))
...
*' and manure excreted on pasture land:
 q51_emissionbal_man_past(i2,n_pollutants_direct) ..
  ...
  q51_emissionbal_man_past_detailed(i2,kli,n_pollutants_direct) ..
                  v51_emissionbal_manure_past_detailed(i2,kli,n_pollutants_direct)
                   =e=
                  sum(awms_prp,
                      vm_manure(i2, kli, awms_prp, "nr")
                      * f51_ef3_prp(i2,n_pollutants_direct,kli))
