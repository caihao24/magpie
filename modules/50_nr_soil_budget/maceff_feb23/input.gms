...
*   options:   history
$setglobal c50_reg_fertilizer_costs  rm330
*   options:   bas, rm120,rm150,rm180,rm210,rm240,rm270,rm300,rm330,rm360,rm390,rm415,rm420,rm450
scalar
...
sets
  cropneff_countries(iso)   countries to be affected by chosen crop neff scenario / CHN,  TWN,  MAC,  HKG /
  pastneff_countries(iso)   countries to be affected by chosen pasture neff scenario / CHN,  TWN,  MAC,  HKG /
;
...
table f50_fertilizer_costs(t_all,i,scen50_reg_fertilizer_costs) Value of fertilizer costs
$ondelim
$include "./modules/50_nr_soil_budget/input/f50_fertilizer_costs.cs3"
$offdelim
;
