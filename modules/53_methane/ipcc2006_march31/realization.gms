...
$Ifi "%phase%" == "sets" $include "./modules/53_methane/ipcc2006_march31/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/53_methane/ipcc2006_march31/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/53_methane/ipcc2006_march31/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/53_methane/ipcc2006_march31/equations.gms"
$Ifi "%phase%" == "preloop" $include "./modules/53_methane/ipcc2006_march31/preloop.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/53_methane/ipcc2006_march31/postsolve.gms"
