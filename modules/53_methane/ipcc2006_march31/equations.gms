...
*' See the module for more on calculation of methane from animal waste(or manure).
 ...
 q53_emissionbal_ch4_awms(i2) ..
  ...
  q53_emissionbal_ch4_awms_detailed(i2,kli)..
    v53_emissionbal_ch4_awms_detailed(i2,kli) =e=
                      vm_manure(i2, kli, "confinement", "nr")
                      * sum(ct,  f53_ef_ch4_awms(ct,i2,kli))
                      * (1-sum(ct, im_maccs_mitigation(ct,i2,"awms","ch4")));
...
*' National Greenhouse Gas Inventories, Eq. 2.27.
 ...
 q53_emissions_resid_burn_detailed(i2,kcr) ..
    v53_emissions_resid_burn_detailed(i2,kcr) =e=
                vm_res_ag_burn(i2,kcr,"dm") * s53_ef_ch4_res_ag_burn;
