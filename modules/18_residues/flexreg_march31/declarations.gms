...
positive variables
 ...
 vm_res_recycling_detailed(i,kcr)       Residues recycled to croplands in respective nutrients Nr P K units detailed (mio. tX)
;
...
equations
 ...
 q18_res_recycling_nr_detailed(i,kcr)      Nutrient recycling of reaactive nitrogen detailed (mio. tNr)
...
parameters
 ...
 ov_res_recycling_detailed(t,i,kcr,type)         Residues recycled to croplands in respective nutrients Nr P K units detailed (mio. tX)
 ...
 oq18_res_recycling_nr_detailed(t,i,kcr,type)    Nutrient recycling of reaactive nitrogen detailed (mio. tNr)
;
