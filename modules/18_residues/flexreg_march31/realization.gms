...
$Ifi "%phase%" == "sets" $include "./modules/18_residues/flexreg_march31/sets.gms"
$Ifi "%phase%" == "declarations" $include "./modules/18_residues/flexreg_march31/declarations.gms"
$Ifi "%phase%" == "input" $include "./modules/18_residues/flexreg_march31/input.gms"
$Ifi "%phase%" == "equations" $include "./modules/18_residues/flexreg_march31/equations.gms"
$Ifi "%phase%" == "scaling" $include "./modules/18_residues/flexreg_march31/scaling.gms"
$Ifi "%phase%" == "preloop" $include "./modules/18_residues/flexreg_march31/preloop.gms"
$Ifi "%phase%" == "presolve" $include "./modules/18_residues/flexreg_march31/presolve.gms"
$Ifi "%phase%" == "postsolve" $include "./modules/18_residues/flexreg_march31/postsolve.gms"
