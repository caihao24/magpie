...
im_physical_inactivity(t_all,iso_cha,sex,age) = f09_physical_inactivity(t_all,iso_cha,"%c09_pal_scenario%",sex,age);
im_demography(t_all,iso_cha,sex,age) = f09_demography(t_all,iso_cha,"%c09_pop_scenario%",sex,age) + 0.000001;
im_pop_iso(t_all,iso_cha) = f09_pop_iso(t_all,iso_cha,"%c09_pop_scenario%");
im_pop(t_all,i_cha) = i09_pop_raw(t_all,i_cha,"%c09_pop_scenario%");
im_gdp_pc_mer(t_all,i_cha) = i09_gdp_pc_mer_raw(t_all,i_cha,"%c09_gdp_scenario%");
im_gdp_pc_mer_iso(t_all,iso_cha) = i09_gdp_pc_mer_iso_raw(t_all,iso_cha,"%c09_gdp_scenario%");
im_gdp_pc_ppp_iso(t_all,iso_cha) = i09_gdp_pc_ppp_iso_raw(t_all,iso_cha,"%c09_gdp_scenario%");
im_development_state(t_all,i_cha) = f09_development_state(t_all,i_cha,"%c09_gdp_scenario%");
im_physical_inactivity(t_all,iso_noncha,sex,age) = f09_physical_inactivity(t_all,iso_noncha,"SSP2",sex,age);
im_demography(t_all,iso_noncha,sex,age) = f09_demography(t_all,iso_noncha,"SSP2",sex,age) + 0.000001;
im_pop_iso(t_all,iso_noncha) = f09_pop_iso(t_all,iso_noncha,"SSP2");
im_pop(t_all,i_noncha) = i09_pop_raw(t_all,i_noncha,"SSP2");
im_gdp_pc_mer(t_all,i_noncha) = i09_gdp_pc_mer_raw(t_all,i_noncha,"SSP2");
im_gdp_pc_mer_iso(t_all,iso_noncha) = i09_gdp_pc_mer_iso_raw(t_all,iso_noncha,"SSP2");
im_gdp_pc_ppp_iso(t_all,iso_noncha) = i09_gdp_pc_ppp_iso_raw(t_all,iso_noncha,"SSP2");
im_development_state(t_all,i_noncha) = f09_development_state(t_all,i_noncha,"SSP2");
 );
);
